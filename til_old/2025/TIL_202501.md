...
- **패스트캠퍼스:** _9개 프로젝트로 경험하는 대용량 트래픽 & 데이터 처리 초격차 패키지 Online._
    - Ch 7. Event를 이용한 리팩토링
      - 03\. 주문 과정을 이벤트 드리븐으로 재구성
        - payment, delivery 서비스에 event driven 적용
...
- **패스트캠퍼스:** _9개 프로젝트로 경험하는 대용량 트래픽 & 데이터 처리 초격차 패키지 Online._
    - Ch 8. 테스트 전략과 테스트 코드 작성
      - 01\. 소프트웨어 테스트 전략과 도구(JUnit, Mockito)
...
- [김장 게임을 만들었다 😎 ㅋㅋ](https://youtu.be/A58_FWqiekI?si=hXb6tW2zRGamGN60)
  - Unity6 설치
    - 설치 후 프로젝트 생성시 에러가 발생했다. 
    디스크 저장공간이 부족했을 때 발생하는 현상인 것 같아서 용량을 확보하니 프로젝트를 생성이 완료됐다.
  - 세팅, 배경 설정 챕터까지 완료
  - 배경 스크롤 구현
  - 캐릭터 점프 구현
### 💻 gb2024
- view-transition api로 화면전환 효과 적용
