...
## ✏️ 2026.07.25
> **🎮 역전면접 MVP**
>   - Notion 기획과 1스테이지 현장 운영실습·회사 선택지 구조를 정리했다.
...
## ✏️ 2026.07.26
> **🖼️ gb2024 v2 운영 개선**
>   - 최신 글 기반 메인 히어로·Travel 최신순·미디어 radius token화를 반영했다.
>   - About 캐러셀에서 선택 사진 6장을 제외해 21장으로 정리했다.
>   - About 캐러셀·메인 히어로를 main에서 검증 후 `620222b` blue-green 운영 배포했다.

---

## ✏️ 2026.07.27
> **🤖 Beast Heart v2 운영 안전·관측**
>   - 주문 차단 알림을 매매 채널로 분리하고 safety 경로는 유지해 dispatcher 74 tests로 고정했다.
>   - DB 보존·compaction 절차를 안전화하고 Dynamic Exit raw tick은 기본 prune/downsampling 금지로 현행화했다.
...
## ✏️ 2026.07.29
> **🌍 gb2024 v2 상세 UI 정리**
>   - 메인 카드 날짜·시간을 24시간 `HH:mm` 형식으로 통일하고 초 표기를 제거했다.
