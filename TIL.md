...
- 프롬프트 엔지니어링 학습
  - 패스트 캠퍼스 'The RED : 프롬프트 엔지니어링, LLM(ChatGPT) 기반의 AI 서비스 개발'
    - Part 2. AI의 역사, LLM 현황 및 핵심 개념 이해
      - CH06. 파인튜닝 vs 프롬프트 엔지니어링
    - Part 4. 프롬프트 엔지니어링 기초 지식
      - CH04. 프롬프트보안
        - 자세한 설명은 없고 이런 것들이 있다 정도의 내용이어서 조금 아쉬웠다.
...
- 프롬프트 엔지니어링 학습
  - 패스트 캠퍼스 'The RED : 프롬프트 엔지니어링, LLM(ChatGPT) 기반의 AI 서비스 개발'
    - Part 5. 프롬프트 엔지니어링 기초 실습
      - CH03. 자연어 처리 태스크 Top 10
      - CH04. 프롬프팅 테크닉 Top 7 실습
      - CH05. 액팅 & 포맷팅
      - CH06. 프롬프트 체이닝
      - CH07. 좋은 프롬프트 만들기
...
- 프롬프트 엔지니어링 학습
  - 패스트 캠퍼스 'The RED : 프롬프트 엔지니어링, LLM(ChatGPT) 기반의 AI 서비스 개발'
    - Part 6. 프롬프트 엔지니어링 응용 심화
      - CH01. 적합한 모델 선택하기
      - CH02. Function Calling (Tooling)
      - CH03. 프롬프트 평가와 테스팅
...
- 토이 프로젝트
  - 요약 기능 수정
    - 명령 프롬프트 수정 : chatGPT에게 도움을 받아서 보다 구체적인 내용 추가 & 영문으로 작성
    - 응답에 한 줄 요약 추가
    - 감정분석도 chatGPT를 통해서 처리 & 수치화 (-1.0~1.0)
