...
- 리사이즈 처리 개선
  - 세로 이미지 처리 오류 수정
  - 썸네일에 리사이즈 비율이 적용되는 문제 수정
  - 운영 배포. SSE 허용 관련 nginx 설정 추가
...
- 리사이즈 처리 개선
  - 색상 프로필 정보 유지
  - 워터마크 추가시 이미지 회전 정보를 반영하여 적용

---

## ✏️ 2025.02.25
### 💻 LLM 테스트
- genai api로 gemini 호출 테스트
...
- **패스트캠퍼스:** _Spring 환경에 바로 적용하는 테스트의 모든 것 초격차 패키지 Online_
  - Part 1. 소프트웨어 테스트 전략과 도구 이해하기
    - Ch 2. 다양한 테스트 종류와 계층 구조 이해하기
      - 06\. 성능 테스트 nGrinder, JMeter 소개 및 기본 사용법 실습
      - 10\. 아키텍처 테스트 ArchUnit 소개 및 기본 사용법 실습
