...
> **Cursor-rules 작성**
>   - 앞으로 TIL 프로젝트의 커밋 메시지는 cursor가 작성하고 push 하도록 cursor-rules를 생성했다.
...
>       - Chapter 8. AI 에이전트 구현하기
>           - 8.5 CrewAI 예제 따라하기
>               - 검색 agent로 Tavily를 사용했는데, 한국어로 검색할 때보다 영어로 검색했을 때의 결과가 훨씬 좋았다.
>           - 8.6 랭그래프 예제 따라하기
>               - colab으로 했는데 예제의 버전이 안맞아서 시행착오가 있었다.

> **💻 토이프로젝트 : 나무위키 실검 크롤러**
>   - 나무위키 인기 검색어 요약 및 텔레그램 자동 전송 기능 추가
...
## ✏️ 2025.06.29
> **💻 토이프로젝트 : 나무위키 실검 크롤러**
>   - description을 생성하지 못한 키워드들은 Perplexity+Gemini를 활용하여 요약정보 생성
>   - 집계 기준을 상위 15개로 확대
