...
>   - Codex 한도 초과로 중단된 근거 15건을 보강해 후보 7건의 발행 준비 상태를 복구했다.
>   - 기사 원발행시각을 복원하고 오래되거나 불명확한 근거를 교체해 Notion 최종본을 재발행했다.
>   - 완료 근거에 타임존 포함 발행시각을 필수화하고 회귀 테스트 후 `939a406`으로 push했다.
