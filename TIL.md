...
- 리사이즈 처리 개선
  - aws lambda cold start 방지 처리
    - 메모리 증설로 CPU 처리 속도 증가 시킴 : 128M -> 256M -> 512M
      - 메모리를 올린만큼 빨라진 것이 체감됐다.
      - 비용이 얼마나 나올지 지켜봐야겠다.
    - EventBridge로 5분마다 호출하도록 설정
  - 리사이즈 처리 완료 후 업로드한 이미지 삭제
  - front쪽 스크립트, 이벤트 처리 보완
...
- **패스트캠퍼스:** _Spring 환경에 바로 적용하는 테스트의 모든 것 초격차 패키지 Online_
  - Part 1. 소프트웨어 테스트 전략과 도구 이해하기
    - Ch 2. 다양한 테스트 종류와 계층 구조 이해하기
      - 09\. 아키텍처 테스트 ArchUnit 소개 및 기본 사용법 이론
...
- **패스트캠퍼스:** _Spring 환경에 바로 적용하는 테스트의 모든 것 초격차 패키지 Online_
  - Part 1. 소프트웨어 테스트 전략과 도구 이해하기
    - Ch 2. 다양한 테스트 종류와 계층 구조 이해하기
      - 06\. 성능 테스트 nGrinder, JMeter 소개 및 기본 사용법 실습